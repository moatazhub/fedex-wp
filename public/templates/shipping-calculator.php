...
<!--                <input type="text" class="input-text" value="--><?php //echo esc_attr( WC()->customer->get_shipping_city() ); ?><!--" placeholder="--><?php //esc_attr_e( 'City', 'woocommerce' ); ?><!--" name="calc_shipping_city" id="calc_shipping_city" />-->
                <select name="calc_shipping_city" class="city_select" id="calc_shipping_city" data-placeholder="<?php esc_attr_e( 'City', 'woocommerce' ); ?>">
                    <option value=""><?php esc_html_e( 'Select an option&hellip;', 'woocommerce' ); ?></option>
                    <?php
                    foreach ( egexpress_shipping_cities_value_only() as $ckey => $cvalue ) {
                        echo '<option value="' . esc_attr( $ckey ) . '" ' . selected( esc_attr( WC()->customer->get_shipping_city() ), $cvalue, false ) . '>' . esc_html( $cvalue ) . '</option>';
                    }
                    ?>
                </select>
            </p>
